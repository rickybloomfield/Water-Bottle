...
/// The two payloads that cross between the phone and the watch. Both sides encode JSON
/// into a WatchConnectivity dictionary so neither has to know about the other's types.
enum WatchMessage {
